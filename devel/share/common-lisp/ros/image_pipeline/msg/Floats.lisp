...
(cl:in-package image_pipeline-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Floats>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name image_pipeline-msg:<Floats> is deprecated: use image_pipeline-msg:Floats instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Floats>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_pipeline-msg:data-val is deprecated.  Use image_pipeline-msg:data instead.")
  (data m))
